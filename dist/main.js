...
/* harmony import */ var _luigi_project_client__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6);
...
/* harmony import */ var react_router_dom__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7);
/**
...
var useGetPathParams = function useGetPathParams(pathInfo) {
  if (pathInfo === void 0) {
    pathInfo = {};
  }
  ...
  var _useState2 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(),
    pathParams = _useState2[0],
    setPathParams = _useState2[1];
  var getLocalParams = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(function () {
    var _pathInfo = pathInfo,
      _pathInfo$params = _pathInfo.params,
      params = _pathInfo$params === void 0 ? {} : _pathInfo$params;
    setPathParams(params);
    setLoaded(true);
  }, [pathInfo]);
  var getDxpParams = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(function () {
    var _pathInfo2 = pathInfo,
      _pathInfo2$path = _pathInfo2.path,
      path = _pathInfo2$path === void 0 ? '' : _pathInfo2$path;
    var pathSegments = path.split('/').filter(Boolean);
    var pathParams = _luigi_project_client__WEBPACK_IMPORTED_MODULE_1___default().getPathParams();
    var i = 0;
    var j = 1;
    ...
    while (i < len) {
      ...
      var vs = Reflect.get(pathParams, "virtualSegment_" + j);
      if (vs === '#') {
        j++;
        continue;
      }
    ...
    params = _extends({}, params, pathParams);
...
var createSearchParams = function createSearchParams(init) {
  if (init === void 0) {
    init = '';
  }
...
var useGetSearchParams$2 = function useGetSearchParams(searchKeys) {
  if (searchKeys === void 0) {
    searchKeys = [];
  }
  ...
  var _useState4 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)({}),
    iframeParams = _useState4[0],
    setIframeParams = _useState4[1];
  var _useState5 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(searchKeys),
    localSearchKeys = _useState5[0];
  var hasSearchKeys = (0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(function () {
    return !!(localSearchKeys != null && localSearchKeys.length);
  }, [localSearchKeys]);
  var hasIframeParams = (0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(function () {
    return !!Object.keys(iframeParams).length;
  }, [iframeParams]);
  var getSearchParams = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(function (search) {
    var searchParams = new URLSearchParams(search);
    var params = Object.fromEntries(searchParams);
    return localSearchKeys != null && localSearchKeys.length ? getSubset(params, localSearchKeys) : params;
  }, [localSearchKeys]);
  var checkParams = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(function (params) {
    if (!params || !Object.keys(params).length) {
      return false;
    }
    if (hasSearchKeys) {
  ...
  // For iframe url
  var getIframeSearchParams = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(function (search) {
    if (search === void 0) {
  ...
  // For DXP url
  var getDxpSearchParams = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(function () {
    var params = _luigi_project_client__WEBPACK_IMPORTED_MODULE_1___default().getNodeParams(true);
...
const useGetSearchParams$3 = useGetSearchParams$2;
...
var useSearchParams = function useSearchParams(defaultInit) {
  ...
  var setSearchParams = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(function (nextInit, navigateOptions) {
    if (navigateOptions != null && navigateOptions.replace) {
      history.replace("?" + createSearchParams(nextInit), navigateOptions == null ? void 0 : navigateOptions.state);
    } else {
      history.push("?" + createSearchParams(nextInit), navigateOptions == null ? void 0 : navigateOptions.state);
    }
  }, [history]);
...
var useGetSearchParams = function useGetSearchParams(keys) {
  if (keys === void 0) {
    keys = [];
  }
  ...
  var _useState = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(keys),
    searchKeys = _useState[0];
  return [(0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(function () {
    var params = Object.fromEntries(searchParams);
    return searchKeys != null && searchKeys.length ? getSubset(params, searchKeys) : params;
  }, [searchParams, searchKeys]), (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(function (params) {
    var o = getCleanObj(_extends({}, Object.fromEntries(searchParams), params));
    return setSearchParams(o);
  }, [searchParams, setSearchParams])];
};
const useGetSearchParams$1 = useGetSearchParams;

var useMixSearchParams = function useMixSearchParams(searchKeys) {
  if (searchKeys === void 0) {
    searchKeys = [];
  }
  var location = (0,react_router_dom__WEBPACK_IMPORTED_MODULE_2__.useLocation)();
  ...
  var _useSearchParams = useGetSearchParams$1(searchKeys),
    searchParams2 = _useSearchParams[0],
    setSearchParams = _useSearchParams[1];
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    if (isLoaded) {
      return;
...
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(12);
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(prop_types__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var history__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(28);
/* harmony import */ var tiny_warning__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(11);
/* harmony import */ var mini_create_react_context__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(10);
/* harmony import */ var tiny_invariant__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(22);
/* harmony import */ var _babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(23);
/* harmony import */ var path_to_regexp__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(24);
...
/* harmony import */ var react_is__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(13);
/* harmony import */ var _babel_runtime_helpers_esm_objectWithoutPropertiesLoose__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(26);
/* harmony import */ var hoist_non_react_statics__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(27);
...
if (process.env.NODE_ENV !== "production") {
  ...
  Router.prototype.componentDidUpdate = function (prevProps) {
    process.env.NODE_ENV !== "production" ? (0,tiny_warning__WEBPACK_IMPORTED_MODULE_10__["default"])(prevProps.history === this.props.history, "You cannot change <Router history>") : void 0;
  };
}
...
if (process.env.NODE_ENV !== "production") {
  ...
  MemoryRouter.prototype.componentDidMount = function () {
    process.env.NODE_ENV !== "production" ? (0,tiny_warning__WEBPACK_IMPORTED_MODULE_10__["default"])(!this.props.history, "<MemoryRouter> ignores the history prop. To use a custom history, " + "use `import { Router }` instead of `import { MemoryRouter as Router }`.") : void 0;
  };
}
...
function Prompt(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_1___default().createElement(context.Consumer, null, function (context) {
    !context ? process.env.NODE_ENV !== "production" ? (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_3__["default"])(false, "You should not use <Prompt> outside a <Router>") : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_3__["default"])(false) : void 0;
...
function Redirect(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_1___default().createElement(context.Consumer, null, function (context) {
    !context ? process.env.NODE_ENV !== "production" ? (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_3__["default"])(false, "You should not use <Redirect> outside a <Router>") : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_3__["default"])(false) : void 0;
...
function evalChildrenDev(children, props, path) {
  ...
  process.env.NODE_ENV !== "production" ? (0,tiny_warning__WEBPACK_IMPORTED_MODULE_10__["default"])(value !== undefined, "You returned `undefined` from the `children` function of " + ("<Route" + (path ? " path=\"" + path + "\"" : "") + ">, but you ") + "should have returned a React element or `null`") : void 0;
  return value || null;
}
/**
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return react__WEBPACK_IMPORTED_MODULE_1___default().createElement(context.Consumer, null, function (context$1) {
      !context$1 ? process.env.NODE_ENV !== "production" ? (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_3__["default"])(false, "You should not use <Route> outside a <Router>") : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_3__["default"])(false) : void 0;
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default().createElement(context.Provider, {
        value: props
      }, props.match ? children ? typeof children === "function" ? process.env.NODE_ENV !== "production" ? evalChildrenDev(children, props, _this.props.path) : children(props) : children : component ? react__WEBPACK_IMPORTED_MODULE_1___default().createElement(component, props) : render ? render(props) : null : typeof children === "function" ? process.env.NODE_ENV !== "production" ? evalChildrenDev(children, props, _this.props.path) : children(props) : null);
    });
  };
...
if (process.env.NODE_ENV !== "production") {
  ...
  Route.prototype.componentDidMount = function () {
    process.env.NODE_ENV !== "production" ? (0,tiny_warning__WEBPACK_IMPORTED_MODULE_10__["default"])(!(this.props.children && !isEmptyChildren(this.props.children) && this.props.component), "You should not use <Route component> and <Route children> in the same route; <Route component> will be ignored") : void 0;
    process.env.NODE_ENV !== "production" ? (0,tiny_warning__WEBPACK_IMPORTED_MODULE_10__["default"])(!(this.props.children && !isEmptyChildren(this.props.children) && this.props.render), "You should not use <Route render> and <Route children> in the same route; <Route render> will be ignored") : void 0;
    process.env.NODE_ENV !== "production" ? (0,tiny_warning__WEBPACK_IMPORTED_MODULE_10__["default"])(!(this.props.component && this.props.render), "You should not use <Route component> and <Route render> in the same route; <Route render> will be ignored") : void 0;
  };

  Route.prototype.componentDidUpdate = function (prevProps) {
    process.env.NODE_ENV !== "production" ? (0,tiny_warning__WEBPACK_IMPORTED_MODULE_10__["default"])(!(this.props.location && !prevProps.location), '<Route> elements should not change from uncontrolled to controlled (or vice versa). You initially used no "location" prop and then provided one on a subsequent render.') : void 0;
    process.env.NODE_ENV !== "production" ? (0,tiny_warning__WEBPACK_IMPORTED_MODULE_10__["default"])(!(!this.props.location && prevProps.location), '<Route> elements should not change from controlled to uncontrolled (or vice versa). You provided a "location" prop initially but omitted it on a subsequent render.') : void 0;
  };
}
...
function staticHandler(methodName) {
  return function () {
     process.env.NODE_ENV !== "production" ? (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_3__["default"])(false, "You cannot %s with <StaticRouter>", methodName) : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_3__["default"])(false) ;
  };
}
...
if (process.env.NODE_ENV !== "production") {
  ...
  StaticRouter.prototype.componentDidMount = function () {
    process.env.NODE_ENV !== "production" ? (0,tiny_warning__WEBPACK_IMPORTED_MODULE_10__["default"])(!this.props.history, "<StaticRouter> ignores the history prop. To use a custom history, " + "use `import { Router }` instead of `import { StaticRouter as Router }`.") : void 0;
  };
}
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return react__WEBPACK_IMPORTED_MODULE_1___default().createElement(context.Consumer, null, function (context) {
      !context ? process.env.NODE_ENV !== "production" ? (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_3__["default"])(false, "You should not use <Switch> outside a <Router>") : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_3__["default"])(false) : void 0;
...
if (process.env.NODE_ENV !== "production") {
  ...
  Switch.prototype.componentDidUpdate = function (prevProps) {
    process.env.NODE_ENV !== "production" ? (0,tiny_warning__WEBPACK_IMPORTED_MODULE_10__["default"])(!(this.props.location && !prevProps.location), '<Switch> elements should not change from uncontrolled to controlled (or vice versa). You initially used no "location" prop and then provided one on a subsequent render.') : void 0;
    process.env.NODE_ENV !== "production" ? (0,tiny_warning__WEBPACK_IMPORTED_MODULE_10__["default"])(!(!this.props.location && prevProps.location), '<Switch> elements should not change from controlled to uncontrolled (or vice versa). You provided a "location" prop initially but omitted it on a subsequent render.') : void 0;
  };
}
...
function withRouter(Component) {
  ...
  var C = function C(props) {
    ...
    return react__WEBPACK_IMPORTED_MODULE_1___default().createElement(context.Consumer, null, function (context) {
      !context ? process.env.NODE_ENV !== "production" ? (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_3__["default"])(false, "You should not use <" + displayName + " /> outside a <Router>") : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_3__["default"])(false) : void 0;
...
function useHistory() {
  if (process.env.NODE_ENV !== "production") {
    !(typeof useContext === "function") ? process.env.NODE_ENV !== "production" ? (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_3__["default"])(false, "You must use React >= 16.8 in order to use useHistory()") : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_3__["default"])(false) : void 0;
  }
...
function useLocation() {
  if (process.env.NODE_ENV !== "production") {
    !(typeof useContext === "function") ? process.env.NODE_ENV !== "production" ? (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_3__["default"])(false, "You must use React >= 16.8 in order to use useLocation()") : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_3__["default"])(false) : void 0;
  }
...
function useParams() {
  if (process.env.NODE_ENV !== "production") {
    !(typeof useContext === "function") ? process.env.NODE_ENV !== "production" ? (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_3__["default"])(false, "You must use React >= 16.8 in order to use useParams()") : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_3__["default"])(false) : void 0;
  }
...
function useRouteMatch(path) {
  if (process.env.NODE_ENV !== "production") {
    !(typeof useContext === "function") ? process.env.NODE_ENV !== "production" ? (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_3__["default"])(false, "You must use React >= 16.8 in order to use useRouteMatch()") : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_3__["default"])(false) : void 0;
  }
...
/* harmony export */ });
/* harmony import */ var _setPrototypeOf_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9);
...
/* harmony import */ var resolve_pathname__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(29);
/* harmony import */ var value_equal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(30);
/* harmony import */ var tiny_warning__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(11);
/* harmony import */ var tiny_invariant__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(22);
...
function createTransitionManager() {
  ...
  function setPrompt(nextPrompt) {
    process.env.NODE_ENV !== "production" ? (0,tiny_warning__WEBPACK_IMPORTED_MODULE_4__["default"])(prompt == null, 'A history supports only one prompt at a time') : void 0;
    prompt = nextPrompt;
    return function () {
    ...
    if (prompt != null) {
      ...
      if (typeof result === 'string') {
        if (typeof getUserConfirmation === 'function') {
          ...
          process.env.NODE_ENV !== "production" ? (0,tiny_warning__WEBPACK_IMPORTED_MODULE_4__["default"])(false, 'A history needs a getUserConfirmation function in order to use a prompt message') : void 0;
          callback(true);
        }
      } else {
...
function createBrowserHistory(props) {
  ...
  !canUseDOM ? process.env.NODE_ENV !== "production" ? (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_3__["default"])(false, 'Browser history needs a DOM') : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_3__["default"])(false) : void 0;
  ...
  function getDOMLocation(historyState) {
    ...
    process.env.NODE_ENV !== "production" ? (0,tiny_warning__WEBPACK_IMPORTED_MODULE_4__["default"])(!basename || hasBasename(path, basename), 'You are attempting to use a basename on a page whose URL path does not begin ' + 'with the basename. Expected path "' + path + '" to begin with "' + basename + '".') : void 0;
  ...
  function push(path, state) {
    process.env.NODE_ENV !== "production" ? (0,tiny_warning__WEBPACK_IMPORTED_MODULE_4__["default"])(!(typeof path === 'object' && path.state !== undefined && state !== undefined), 'You should avoid providing a 2nd state argument to push when the 1st ' + 'argument is a location-like object that already has state; it is ignored') : void 0;
    var action = 'PUSH';
    ...
    transitionManager.confirmTransitionTo(location, action, getUserConfirmation, function (ok) {
      ...
      if (canUseHistory) {
        ...
        process.env.NODE_ENV !== "production" ? (0,tiny_warning__WEBPACK_IMPORTED_MODULE_4__["default"])(state === undefined, 'Browser history cannot push state in browsers that do not support HTML5 history') : void 0;
        window.location.href = href;
      }
    });
  }
  ...
  function replace(path, state) {
    process.env.NODE_ENV !== "production" ? (0,tiny_warning__WEBPACK_IMPORTED_MODULE_4__["default"])(!(typeof path === 'object' && path.state !== undefined && state !== undefined), 'You should avoid providing a 2nd state argument to replace when the 1st ' + 'argument is a location-like object that already has state; it is ignored') : void 0;
    var action = 'REPLACE';
    var location = createLocation(path, state, createKey(), history.location);
    transitionManager.confirmTransitionTo(location, action, getUserConfirmation, function (ok) {
      if (!ok) return;
      ...
      if (canUseHistory) {
        ...
        process.env.NODE_ENV !== "production" ? (0,tiny_warning__WEBPACK_IMPORTED_MODULE_4__["default"])(state === undefined, 'Browser history cannot replace state in browsers that do not support HTML5 history') : void 0;
        window.location.replace(href);
      }
    });
  }
...
function createHashHistory(props) {
  ...
  !canUseDOM ? process.env.NODE_ENV !== "production" ? (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_3__["default"])(false, 'Hash history needs a DOM') : (0,tiny_invariant__WEBPACK_IMPORTED_MODULE_3__["default"])(false) : void 0;
  var globalHistory = window.history;
  ...
  function push(path, state) {
    process.env.NODE_ENV !== "production" ? (0,tiny_warning__WEBPACK_IMPORTED_MODULE_4__["default"])(state === undefined, 'Hash history cannot push state; it is ignored') : void 0;
    var action = 'PUSH';
    ...
    transitionManager.confirmTransitionTo(location, action, getUserConfirmation, function (ok) {
      ...
      if (hashChanged) {
        ...
        process.env.NODE_ENV !== "production" ? (0,tiny_warning__WEBPACK_IMPORTED_MODULE_4__["default"])(false, 'Hash history cannot PUSH the same path; a new entry will not be added to the history stack') : void 0;
        setState();
      }
    });
  }
  ...
  function replace(path, state) {
    process.env.NODE_ENV !== "production" ? (0,tiny_warning__WEBPACK_IMPORTED_MODULE_4__["default"])(state === undefined, 'Hash history cannot replace state; it is ignored') : void 0;
    var action = 'REPLACE';
    var location = createLocation(path, undefined, undefined, history.location);
    transitionManager.confirmTransitionTo(location, action, getUserConfirmation, function (ok) {
      if (!ok) return;
  ...
  function go(n) {
    process.env.NODE_ENV !== "production" ? (0,tiny_warning__WEBPACK_IMPORTED_MODULE_4__["default"])(canGoWithoutReload, 'Hash history go(n) causes a full page reload in this browser') : void 0;
    globalHistory.go(n);
  }
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _eureka_hybrid_portal_adapter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5);
/* harmony import */ var _a__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4);



console.log(_eureka_hybrid_portal_adapter__WEBPACK_IMPORTED_MODULE_2__["default"]);
