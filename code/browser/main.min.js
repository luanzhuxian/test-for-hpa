  ...
  var _e$useState = e.useState(!1),
    ...
    u = e.useCallback(function () {
      var _s$params = s.params,
        e = _s$params === void 0 ? {} : _s$params;
      o(e), r(!0);
    }, [s]),
    l = e.useCallback(function () {
      var _s$path = s.path,
        e = _s$path === void 0 ? "" : _s$path,
      ...
      for (; n < l;) {
        var _e = a[n],
          _t = Reflect.get(c, "virtualSegment_".concat(u));
        if ("#" !== _t) {
          if (_e.startsWith(":")) {
            var _s = _e.slice(1);
            _s && _t && Reflect.set(f, _s, decodeURIComponent(_t.replace(/\+/g, " ")));
          } else _e === _t && u++;
          n++;
        } else u++;
      }
      f = _objectSpread(_objectSpread({}, f), c), f && Object.keys(f).length && (o(f), r(!0));
    }, [s]);
...
var o = function o(e, t) {
    var s = Object.entries(e).filter(function (_ref) {
  ...
  u = function u() {
    ...
    return new URLSearchParams("string" == typeof e || Array.isArray(e) || e instanceof URLSearchParams ? e : Object.keys(e).reduce(function (t, s) {
      var a = e[s];
      return t.concat(Array.isArray(a) ? a.map(function (e) {
        return [s, e];
      }) : [[s, a]]);
    }, []));
  };
var l = function l() {
  ...
  var r = s.useLocation(),
    ...
    f = _e$useState10[0],
    h = _e$useState10[1],
    _e$useState11 = e.useState({}),
    _e$useState12 = _slicedToArray(_e$useState11, 2),
    i = _e$useState12[0],
    m = _e$useState12[1],
    _e$useState13 = e.useState(a),
    _e$useState14 = _slicedToArray(_e$useState13, 1),
    d = _e$useState14[0],
    b = e.useMemo(function () {
      return !!(d !== null && d !== void 0 && d.length);
    }, [d]),
    ...
    S = e.useCallback(function (e) {
      ...
      return d !== null && d !== void 0 && d.length ? o(s, d) : s;
    }, [d]),
    g = e.useCallback(function (e) {
      return !(!e || !Object.keys(e).length);
    }, [b]),
    E = e.useCallback(function () {
      var e = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : r.search;
      var t = S(e);
      h(t), n(!0);
    }, [S, r.search]),
    P = e.useCallback(function () {
      var e = t.getNodeParams(!0);
      g(e) ? (h(_objectSpread({}, e)), n(!0)) : l(function (e) {
        return e + 1;
      });
    }, [g]);
  return e.useEffect(function () {
    var e = S(r.search);
    m(e);
  }, [r.search, S]), e.useEffect(function () {
    p ? E() : (n(!1), l(0));
  }, [p, E]), e.useEffect(function () {
    c || (u >= 5 ? n(!0) : P());
  }, [c, u, P]), {
    loaded: c,
    setLoaded: n,
...
var f = function f(t) {
  ...
  return [e.useMemo(function () {
    var e = u(a.search);
    var _iterator = _createForOfIteratorHelper(c.current.keys()),
      _step;
    try {
      var _loop = function _loop() {
        var t = _step.value;
        e.has(t) || c.current.getAll(t).forEach(function (s) {
          e.append(t, s);
        });
      };
    ...
    return e;
  }, [a.search]), e.useCallback(function (e, t) {
    t !== null && t !== void 0 && t.replace ? r.replace("?".concat(u(e)), t === null || t === void 0 ? void 0 : t.state) : r.push("?".concat(u(e)), t === null || t === void 0 ? void 0 : t.state);
  }, [r])];
};
var h = function h() {
  ...
  var _f = f(),
    ...
    s = _f2[0],
    a = _f2[1],
    _e$useState15 = e.useState(t),
    _e$useState16 = _slicedToArray(_e$useState15, 1),
    r = _e$useState16[0];
  return [e.useMemo(function () {
    var e = Object.fromEntries(s);
    return r !== null && r !== void 0 && r.length ? o(e, r) : e;
  }, [s, r]), e.useCallback(function (e) {
    var t = function (e) {
      if (!e) return {};
      var t = _objectSpread({}, e);
      return Object.keys(t).forEach(function (e) {
        var s;
        (null == (s = t[e]) || "" === s) && delete t[e];
      }), t;
    }(_objectSpread(_objectSpread({}, Object.fromEntries(s)), e));
    return a(t);
  }, [s, a])];
};
var i = function i() {
  ...
  return e.useEffect(function () {
    r || u && f && (o(f), c(!0));
  }, [r, u, f]), e.useEffect(function () {
    r || i && i.tab && (o(i), c(!0));
  }, [r, i]), e.useEffect(function () {
    c(!1);
  }, [a.search]), {
    isLoaded: r,
    setIsLoaded: c,
...
var m = {
  hooks: Object.freeze({
    __proto__: null,
    useGetPathParams: n,
    useGetSearchParams: l,
    useMixSearchParams: i,
    useSearchParams: h
  }),
  getEnv: function getEnv() {
    return a;
  },
  setEnv: function setEnv(e) {
    "dxp" === e || "stand_alone" === e ? a = e : console.warn("Illegal enviroment value! Expect to be 'dxp' or 'stand_alone'.");
  },
  isDxp: r
};
module.exports = m;
