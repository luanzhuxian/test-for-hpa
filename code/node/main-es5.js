  ...
  !function (e, t) {
    ...
    return function (e) {
      ...
      var i = n(0),
        ...
        f = new (function () {
          function e() {
            r()(this, e), this.listeners = [], this.origin = "";
            var t = function (e) {
              if (e.data.msg) if ("custom" === e.data.msg) {
                var t = this.convertCustomMessageInternalToUser(e.data);
                this.listeners.filter(function (e) {
                  return e.name === t.id;
                }).map(function (e) {
                  return e.eventFn(t, e.listenerId);
                });
              } else this.listeners.filter(function (t) {
          ...
          return a()(e, [{
            ...
            value: function value(e) {
              return !!Boolean(this.listeners.find(function (t) {
            ...
            value: function value(e) {
              if (this.origin) try {
                ...
                console.warn("Unable to post message " + e + " to Luigi Core from origin " + this.origin + ": " + t);
              } else console.warn('There is no target origin set. You can specify the target origin by calling LuigiClient.setTargetOrigin("targetorigin") in your micro frontend.');
            }
          }, {
            key: "hasIntent",
            value: function value(e) {
            ...
            value: function value() {
              ...
              return String(e).replaceAll("&lt;", "<").replaceAll("&gt;", ">").replaceAll("&quot;", '"').replaceAll("&#39;", "'").replaceAll("&sol;", "/");
            }
          }]), e;
        }())(),
        h = new (function (e) {
          function t() {
            var e;
            return r()(this, t), (e = u()(this, c()(t).call(this))).luigiInitialized = !1, e.defaultContextKeys = ["context", "internal", "nodeParams", "pathParams", "searchParams"], e.setCurrentContext(e.defaultContextKeys.reduce(function (e, t) {
              return e[t] = {}, e;
            }, {})), e._onContextUpdatedFns = {}, e._onInactiveFns = {}, e._onInitFns = {}, e.authData = {}, e._isDeferInitDefined() || e.luigiClientInit(), e;
          }
          return v()(t, e), a()(t, [{
            ...
            value: function value() {
              var e = this;
              if (this.luigiInitialized) console.warn("Luigi Client has been already initialized");else {
                var t = function t(_t) {
                    for (var n = 0; n < e.defaultContextKeys.length; n++) {
                      var i = e.defaultContextKeys[n];
                      try {
                        "string" == typeof _t[i] && (_t[i] = JSON.parse(_t[i]));
                      } catch (e) {
                        console.info("unable to parse luigi context data for", i, _t[i], e);
                      }
                    }
                    e.setCurrentContext(_t);
                  },
                  i = function i(t) {
                    t && (e.authData = t);
                  };
                f.addEventListener("luigi.init", function (n) {
                  t(n.data), i(n.data.authData), f.setLuigiCoreDomain(n.origin), e.luigiInitialized = !0, e._notifyInit(n.origin), f.sendPostMessageToLuigiCore({
                    msg: "luigi.init.ok"
                  });
                }), f.addEventListener("luigi-client.inactive-microfrontend", function (t) {
                  e._notifyInactive(t.origin);
                }), f.addEventListener("luigi.auth.tokenIssued", function (e) {
                  i(e.data.authData);
                }), f.addEventListener("luigi.navigate", function (n) {
                  if (t(n.data), !e.currentContext.internal.isNavigateBack && !e.currentContext.withoutSync) {
                    var i = window.location.hash;
                    history.replaceState({
                      luigiInduced: !0
                    }, "", n.data.viewUrl), window.dispatchEvent(new PopStateEvent("popstate", {
                      state: "luiginavigation"
                    })), window.location.hash !== i && window.dispatchEvent(new HashChangeEvent("hashchange"));
                  }
                  e.currentContext.withoutSync && Object.assign(e.currentContext.context, {
                    viewUrl: n.data.viewUrl ? n.data.viewUrl : void 0,
                    pathParams: n.data.pathParams ? n.data.pathParams : void 0
                  }), e._notifyUpdate(), f.sendPostMessageToLuigiCore({
                    msg: "luigi.navigate.ok"
                  });
                }), window.parent.postMessage({
                  msg: "luigi.get-context",
                  clientVersion: n(9).version
                }, "*"), this._tpcCheck();
              }
            }
          }, {
            ...
            value: function value() {
              var e,
                ...
                n = "enabled",
                i = document.cookie;
              i && (e = i.split(";").map(function (e) {
                return e.trim();
              }).find(function (e) {
                return "luigiCookie=true" == e;
              })), "luigiCookie=true" === e && (t = e.split("=")[0], document.cookie = t + "=; Max-Age=-99999999;"), document.cookie = "luigiCookie=true; SameSite=None; Secure", (i = document.cookie) && (e = i.split(";").map(function (e) {
                return e.trim();
              }).find(function (e) {
                return "luigiCookie=true" == e;
              })), "luigiCookie=true" === e ? (window.parent.postMessage({
                msg: "luigi.third-party-cookie",
                tpc: n
              }, "*"), document.cookie = t + "=; Max-Age=-99999999;") : (n = "disabled", window.parent.postMessage({
                msg: "luigi.third-party-cookie",
                tpc: n
            ...
            value: function value(e, t, n) {
              for (var i in e) e.hasOwnProperty(i) && f.isFunction(e[i]) && e[i](t, n);
            }
          }, {
            key: "_notifyInit",
            value: function value(e) {
            ...
            value: function value(e) {
              var t = f.getRandomId();
              return this._onInitFns[t] = e, this.luigiInitialized && f.isFunction(e) && e(this.currentContext.context, f.getLuigiCoreDomain()), t;
            }
          }, {
            ...
            value: function value(e) {
              var t = f.getRandomId();
              return this._onContextUpdatedFns[t] = e, this.luigiInitialized && f.isFunction(e) && e(this.currentContext.context), t;
            }
          }, {
            ...
            value: function value(e, t) {
              return f.addEventListener(e, function (e, n) {
                return t(e, n);
              });
            }
          }, {
            ...
            value: function value(e) {
              return f.removeEventListener(e);
            }
          }, {
            key: "getToken",
            value: function value() {
            ...
            value: function value(e) {
              ...
              e && f.sendPostMessageToLuigiCore({
            ...
            value: function value() {
              var e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
              return e ? f.deSanitizeParamsMap(this.currentContext.nodeParams) : this.currentContext.nodeParams;
            }
          }, {
            key: "getPathParams",
            value: function value() {
            ...
            value: function value(e) {
              var t = f.convertCustomMessageUserToInternal(e);
              f.sendPostMessageToLuigiCore(t);
            }
          }, {
            key: "getUserSettings",
            value: function value() {
        ...
        C = function (e) {
          function t(e) {
            var n;
            r()(this, t), (n = u()(this, c()(t).call(this))).validSplitViewEvents = ["expand", "collapse", "resize", "close"], n.splitView = {
              exists: !0,
              size: 40,
              collapsed: !1
            }, Object.assign(n.splitView, e);
            return n.splitView.listeners = [f.addEventListener("luigi.navigation.splitview.internal", function (e) {
          ...
          return v()(t, e), a()(t, [{
            ...
            key: "on",
            value: function value(e, t) {
              if (!this.validSplitViewEvents.includes(e)) return console.warn(e + " is not a valid split view event"), !1;
              var n = f.addEventListener("luigi.navigation.splitview.".concat(e, ".ok"), function (e) {
        ...
        w = function (e) {
          function t(e) {
            var n;
            return r()(this, t), n = u()(this, c()(t).call(this)), Object.assign(k()(n), e), n.options = {
              preserveView: !1,
              nodeParams: {},
          ...
          return v()(t, e), a()(t, [{
            ...
            value: function value(e, t, n, i, r, o) {
              if (this.options.errorSkipNavigation) this.options.errorSkipNavigation = !1;else {
                i && r && o && console.warn("modalSettings, splitViewSettings and drawerSettings cannot be used together. Only modal setting will be taken into account."), this.options.preserveView = n;
                var a = "/" !== e[0];
                if ("/" === e && (i || r || o)) console.warn("Navigation with an absolute path prevented.");else {
                  var s = {
                    ...
                    params: Object.assign(this.options, {
                      link: e,
                      relative: a,
                      intent: f.hasIntent(e),
                      modal: i,
                      splitView: r,
                      drawer: o
                    })
                  };
                  f.sendPostMessageToLuigiCore(s);
                }
              }
            }
          }, {
            ...
            value: function value(e) {
              ...
              if (e) {
                ...
                f.sendPostMessageToLuigiCore(i);
              } else console.warn("Updating path of the modal upon internal navigation prevented. No path specified.");
            }
          }, {
            ...
            value: function value(e) {
              var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
              return this.navigate(e, 0, !0, void 0, t), new C(t);
            }
          }, {
            key: "openAsDrawer",
            value: function value(e) {
            ...
            key: "fromContext",
            value: function value(e) {
              return this.currentContext.context.parentNavigationContexts && -1 !== this.currentContext.context.parentNavigationContexts.indexOf(e) ? this.options.fromContext = e : (this.options.errorSkipNavigation = !0, console.error("Navigation not possible, navigationContext " + e + " not found.")), this;
            }
          }, {
            key: "fromClosestContext",
            value: function value() {
              return this.currentContext && this.currentContext.context.parentNavigationContexts.length > 0 ? (this.options.fromContext = null, this.options.fromClosestContext = !0) : console.error("Navigation not possible, no parent navigationContext found."), this;
            }
          }, {
            ...
            key: "withOptions",
            value: function value(e) {
              return f.isObject(e) ? (void 0 !== e.preventHistoryEntry && (this.options.preventHistoryEntry = e.preventHistoryEntry), void 0 !== e.preventContextUpdate && (this.options.preventContextUpdate = e.preventContextUpdate), this) : this;
            }
          }, {
            key: "pathExists",
            value: function value(e) {
              ...
              }, this.setPromise("pathExistsPromises", n), f.addEventListener("luigi.navigation.pathExists.answer", function (e, n) {
                var i = e.data.data,
                  r = this.getPromise("pathExistsPromises") || {};
                i.correlationId === t && (r[i.correlationId] && (r[i.correlationId].resolveFn(i.pathExists), delete r[i.correlationId], this.setPromise("pathExistsPromises", r)), f.removeEventListener(n));
              }.bind(this));
              var i = {
              ...
              return f.sendPostMessageToLuigiCore(i), n[t];
            }
          }, {
            key: "hasBack",
            value: function value() {
            ...
            value: function value() {
              ...
              }, this.setPromise("getCurrentRoute", n), f.addEventListener("luigi.navigation.currentRoute.answer", function (n, i) {
                var r = n.data.data,
                  o = e.getPromise("getCurrentRoute") || {};
                r.correlationId === t && (o[r.correlationId] && (o[r.correlationId].resolveFn(r.route), delete o[r.correlationId], e.setPromise("getCurrentRoute", o)), f.removeEventListener(i)), f.removeEventListener(i);
              }), f.sendPostMessageToLuigiCore({
        ...
        x = new (function (e) {
          function t() {
            var e;
            return r()(this, t), e = u()(this, c()(t).call(this)), f.addEventListener("luigi.current-locale-changed", function (e) {
              var t;
              e.data.currentLocale && (null === (t = h.currentContext) || void 0 === t ? void 0 : t.internal) && (h.currentContext.internal.currentLocale = e.data.currentLocale, h._notifyUpdate());
            }), e;
          }
          return v()(t, e), a()(t, [{
            ...
            value: function value(e) {
              var t = this;
              f.addEventListener("luigi.ux.confirmationModal.hide", function (e, n) {
                t.hideConfirmationModal(e.data.data), f.removeEventListener(n);
              }), f.sendPostMessageToLuigiCore({
              ...
              }), this.setPromise("confirmationModal", n), n.promise;
            }
          }, {
            ...
            value: function value(e) {
              var t = this;
              f.addEventListener("luigi.ux.alert.hide", function (e, n) {
                t.hideAlert(e.data), f.removeEventListener(n);
              }), e.id = f.getRandomId(), (null == e ? void 0 : e.closeAfter) < 100 && (console.warn("Message with id='".concat(e.id, "' has too small 'closeAfter' value. It needs to be at least 100ms.")), e.closeAfter = void 0), f.sendPostMessageToLuigiCore({
              ...
              return n[e.id] = {}, n[e.id].promise = new Promise(function (t) {
                n[e.id].resolveFn = t;
              }), this.setPromise("alerts", n), n[e.id].promise;
            }
          }, {
            key: "hideAlert",
            value: function value(e) {
              var t = e.id,
                n = e.dismissKey,
                i = this.getPromise("alerts");
              t && i[t] && (i[t].resolveFn(n || t), delete i[t], this.setPromise("alerts", i));
            }
          }, {
            key: "getCurrentLocale",
            value: function value() {
              var e, t;
              return null === (e = h.currentContext) || void 0 === e || null === (t = e.internal) || void 0 === t ? void 0 : t.currentLocale;
            }
          }, {
            ...
            value: function value() {
              var e, t;
              return null === (e = h.currentContext) || void 0 === e || null === (t = e.internal) || void 0 === t ? void 0 : t.splitView;
            }
          }, {
            key: "isModal",
            value: function value() {
              var e, t;
              return null === (e = h.currentContext) || void 0 === e || null === (t = e.internal) || void 0 === t ? void 0 : t.modal;
            }
          }, {
            key: "isDrawer",
            value: function value() {
              var e, t;
              return null === (e = h.currentContext) || void 0 === e || null === (t = e.internal) || void 0 === t ? void 0 : t.drawer;
            }
          }, {
            key: "getCurrentTheme",
            value: function value() {
              var e, t;
              return null === (e = h.currentContext) || void 0 === e || null === (t = e.internal) || void 0 === t ? void 0 : t.currentTheme;
            }
          }]), t;
        }(g))(),
        P = new Map(),
        L = function (e) {
          function t() {
            var e;
            return r()(this, t), (e = u()(this, c()(t).call(this))).storageEventProcessor = new b(), f.addEventListener("storage", function (t, n) {
          ...
          return v()(t, e), a()(t, [{
            ...
            value: function value(e, t) {
              ...
              return new Promise(function (i, r) {
                n.storageEventProcessor.execute(i, r, "setItem", {
                  key: e,
                  value: t
                });
              });
            ...
            value: function value(e) {
              ...
              return new Promise(function (n, i) {
                t.storageEventProcessor.execute(n, i, "getItem", {
                  key: e
                });
              });
            }
            ...
            value: function value(e) {
              var t = this;
              return new Promise(function (n, i) {
                t.storageEventProcessor.execute(n, i, "removeItem", {
                  key: e
                });
              });
            }
            ...
            value: function value(e) {
              var t = this;
              return new Promise(function (n, i) {
                t.storageEventProcessor.execute(n, i, "has", {
                  key: e
                });
              });
            }
        ...
        b = function () {
          ...
          return a()(e, [{
            ...
            value: function value(e, t) {
              try {
                var n = e.data.data;
                if (!P.has(n.id)) return void console.log("Impossible to find Promise method for message " + n.id);
                var i = P.get(n.id);
                "ERROR" === n.status ? i.reject(n.result) : i.resolve(n.result), P["delete"](n.id);
              } catch (e) {
                console.error(e);
              }
            }
            ...
            value: function value(e) {
              for (var t = new Date().getTime(); !syncOperation.has(e);) {
                if (new Date().getTime() - t > 1e4) throw "Storage operation is taking more than 1 second...Some problem with Luigi Core communication";
              }
            ...
            value: function value(e, t, n, i) {
              var r = f.getRandomId();
              this.createPendingOperation(r, e, t), this.sendMessage(r, n, i);
            }
          }, {
        ...
        M = function () {
          function e() {
            r()(this, e), window !== window.top && ("true" !== window.document.head.getAttribute("disable-luigi-history-handling") && (history.pushState = history.replaceState.bind(history)), "true" !== window.document.head.getAttribute("disable-luigi-runtime-error-handling") && window.addEventListener("error", function (e) {
              var t = {
          ...
          return a()(e, [{
            key: "addInitListener",
            value: function value(e) {
              return h.addInitListener(e);
            }
          }, {
            key: "removeInitListener",
            value: function value(e) {
              return h.removeInitListener(e);
            }
          }, {
            key: "addContextUpdateListener",
            value: function value(e) {
              return h.addContextUpdateListener(e);
            }
          }, {
            key: "removeContextUpdateListener",
            value: function value(e) {
              return h.removeContextUpdateListener(e);
            }
          }, {
            key: "getToken",
            value: function value() {
            ...
            key: "addNodeParams",
            value: function value(e, t) {
              return h.addNodeParams(e, t);
            }
          }, {
            key: "getNodeParams",
            value: function value(e) {
              return h.getNodeParams(e);
            }
          }, {
            key: "getActiveFeatureToggles",
            value: function value() {
            ...
            key: "addCoreSearchParams",
            value: function value(e, t) {
              return h.addCoreSearchParams(e, t);
            }
          }, {
            key: "getClientPermissions",
            value: function value() {
            ...
            key: "sendCustomMessage",
            value: function value(e) {
              return h.sendCustomMessage(e);
            }
          }, {
            key: "addCustomMessageListener",
            value: function value(e, t) {
              return h.addCustomMessageListener(e, t);
            }
          }, {
            key: "removeCustomMessageListener",
            value: function value(e) {
              return h.removeCustomMessageListener(e);
            }
          }, {
            key: "addInactiveListener",
            value: function value(e, t) {
              return h.addInactiveListener(e, t);
            }
          }, {
            key: "removeInactiveListener",
            value: function value(e) {
              return h.removeInactiveListener(e);
            }
          }, {
            key: "setTargetOrigin",
            value: function value(e) {
              return h.setTargetOrigin(e);
            }
          }, {
            key: "getUserSettings",
            value: function value() {
            ...
            key: "setAnchor",
            value: function value(e) {
              return h.setAnchor(e);
            }
          }, {
            key: "linkManager",
            value: function value() {
              return new w({
                currentContext: h.currentContext
              });
            }
          }, {
            key: "uxManager",
...
var luigiClientExports = luigiClient.exports;
var LuigiClient = /*@__PURE__*/getDefaultExportFromCjs(luigiClientExports);
...
var useGetPathParams = function useGetPathParams() {
  ...
  var _reactExports$useStat = reactExports.useState(false),
    ...
    loaded = _reactExports$useStat2[0],
    setLoaded = _reactExports$useStat2[1];
  var _reactExports$useStat3 = reactExports.useState(),
    _reactExports$useStat4 = _slicedToArray(_reactExports$useStat3, 2),
    pathParams = _reactExports$useStat4[0],
    setPathParams = _reactExports$useStat4[1];
  var getLocalParams = reactExports.useCallback(function () {
    var _pathInfo$params = pathInfo.params,
      params = _pathInfo$params === void 0 ? {} : _pathInfo$params;
    setPathParams(params);
    setLoaded(true);
  }, [pathInfo]);
  var getDxpParams = reactExports.useCallback(function () {
    ...
    while (i < len) {
      ...
      if (currentPath.startsWith(':')) {
        var _key3 = currentPath.slice(1);
        if (_key3 && vs) {
          Reflect.set(params, _key3, decode(vs));
        }
...
var getSubset = function getSubset(obj, keys) {
  var filteredEntries = Object.entries(obj).filter(function (_ref2) {
...
var useGetSearchParams$2 = function useGetSearchParams$2() {
  ...
  var _reactExports$useStat5 = reactExports.useState(false),
    ...
    loaded = _reactExports$useStat6[0],
    setLoaded = _reactExports$useStat6[1];
  var _reactExports$useStat7 = reactExports.useState(0),
    _reactExports$useStat8 = _slicedToArray(_reactExports$useStat7, 2),
    retry = _reactExports$useStat8[0],
    setRetry = _reactExports$useStat8[1];
  var _reactExports$useStat9 = reactExports.useState({}),
    _reactExports$useStat10 = _slicedToArray(_reactExports$useStat9, 2),
    searchParams = _reactExports$useStat10[0],
    setSearchParams = _reactExports$useStat10[1];
  var _reactExports$useStat11 = reactExports.useState({}),
    _reactExports$useStat12 = _slicedToArray(_reactExports$useStat11, 2),
    iframeParams = _reactExports$useStat12[0],
    setIframeParams = _reactExports$useStat12[1];
  var _reactExports$useStat13 = reactExports.useState(searchKeys),
    _reactExports$useStat14 = _slicedToArray(_reactExports$useStat13, 1),
    localSearchKeys = _reactExports$useStat14[0];
  var hasSearchKeys = reactExports.useMemo(function () {
    return !!(localSearchKeys !== null && localSearchKeys !== void 0 && localSearchKeys.length);
  }, [localSearchKeys]);
  var hasIframeParams = reactExports.useMemo(function () {
    return !!Object.keys(iframeParams).length;
  }, [iframeParams]);
  var getSearchParams = reactExports.useCallback(function (search) {
  ...
  var checkParams = reactExports.useCallback(function (params) {
    if (!params || !Object.keys(params).length) {
      return false;
    }
    if (hasSearchKeys) {
  ...
  // For iframe url
  var getIframeSearchParams = reactExports.useCallback(function () {
  ...
  // For DXP url
  var getDxpSearchParams = reactExports.useCallback(function () {
...
var useGetSearchParams = function useGetSearchParams() {
  ...
  var _reactExports$useStat15 = reactExports.useState(keys),
    _reactExports$useStat16 = _slicedToArray(_reactExports$useStat15, 1),
    searchKeys = _reactExports$useStat16[0];
  return [reactExports.useMemo(function () {
    var params = Object.fromEntries(searchParams);
    return searchKeys !== null && searchKeys !== void 0 && searchKeys.length ? getSubset(params, searchKeys) : params;
  }, [searchParams, searchKeys]), reactExports.useCallback(function (params) {
...
var useMixSearchParams = function useMixSearchParams() {
  ...
  var _reactExports$useStat17 = reactExports.useState(false),
    ...
    isLoaded = _reactExports$useStat18[0],
    setIsLoaded = _reactExports$useStat18[1];
  var _reactExports$useStat19 = reactExports.useState(),
    _reactExports$useStat20 = _slicedToArray(_reactExports$useStat19, 2),
    params = _reactExports$useStat20[0],
    setParams = _reactExports$useStat20[1];
