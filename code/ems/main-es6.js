...
const useGetSearchParams$2 = (searchKeys = []) => {
  ...
  const getSearchParams = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(
    (search) => {
  ...
  const checkParams = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(
    (params) => {
      if (!params || !Object.keys(params).length) {
        return false;
      }
  ...
  // For iframe url
  const getIframeSearchParams = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(
...
const useSearchParams = (defaultInit) => {
  ...
  const defaultSearchParamsRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(createSearchParams(defaultInit));
  ...
  const setSearchParams = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(
